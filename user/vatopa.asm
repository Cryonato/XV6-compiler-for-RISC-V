...
int main (int argc, char* argv[]){
   ...
   6:	1000                	addi	s0,sp,32
    ...
    if (argc < 2){
   8:	4785                	li	a5,1
   a:	04a7d063          	bge	a5,a0,4a <main+0x4a>
   e:	e426                	sd	s1,8(sp)
  10:	e04a                	sd	s2,0(sp)
  12:	84ae                	mv	s1,a1
  ...
  14:	478d                	li	a5,3
  16:	04f50963          	beq	a0,a5,68 <main+0x68>
        pa = va2pa(atoi(argv[1]), atoi(argv[2]));
    } else {
        pa = va2pa(atoi(argv[1]), 0x0);
  1a:	6588                	ld	a0,8(a1)
  1c:	00000097          	auipc	ra,0x0
  20:	1fe080e7          	jalr	510(ra) # 21a <atoi>
  24:	4581                	li	a1,0
  26:	00000097          	auipc	ra,0x0
  2a:	3a6080e7          	jalr	934(ra) # 3cc <va2pa>
  2e:	85aa                	mv	a1,a0
    }
    printf("0x%x\n", pa);
  30:	00001517          	auipc	a0,0x1
  34:	85850513          	addi	a0,a0,-1960 # 888 <malloc+0x12c>
  38:	00000097          	auipc	ra,0x0
  3c:	66c080e7          	jalr	1644(ra) # 6a4 <printf>
    exit(0);
  40:	4501                	li	a0,0
  42:	00000097          	auipc	ra,0x0
  46:	2d2080e7          	jalr	722(ra) # 314 <exit>
  4a:	e426                	sd	s1,8(sp)
  4c:	e04a                	sd	s2,0(sp)
        printf("Usage\\: vatopa virtual_address \\[pid\\]\n");
  4e:	00001517          	auipc	a0,0x1
  52:	81250513          	addi	a0,a0,-2030 # 860 <malloc+0x104>
  56:	00000097          	auipc	ra,0x0
  5a:	64e080e7          	jalr	1614(ra) # 6a4 <printf>
        exit(0);
  5e:	4501                	li	a0,0
  ...
  6e:	1b0080e7          	jalr	432(ra) # 21a <atoi>
  72:	892a                	mv	s2,a0
  74:	6888                	ld	a0,16(s1)
  76:	00000097          	auipc	ra,0x0
  7a:	1a4080e7          	jalr	420(ra) # 21a <atoi>
  7e:	85aa                	mv	a1,a0
  80:	854a                	mv	a0,s2
  82:	00000097          	auipc	ra,0x0
  86:	34a080e7          	jalr	842(ra) # 3cc <va2pa>
  8a:	85aa                	mv	a1,a0
  8c:	b755                	j	30 <main+0x30>
